...
set output 'drag.png'
plot "tRhoCdCl.dat" u 2:4 title "Present Drag" w l ls 1#, Ref_Drag title "Benchmark Drag" ls 2 dashtype "-"
# every ::3000::3200
# Ref_Lift=10.53
set ylabel "Lift Force"
set output 'lift.png'
plot "tRhoCdCl.dat" u 2:5 title "Present Lift" w l ls 1#, Ref_Lift title "Benchmark Lift" ls 2 dashtype "-"

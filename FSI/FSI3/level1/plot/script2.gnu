...
plot "../output/dynamic.dat" every ::399::499 u 1:2 title "code" w l ls 1, "../input/yDisp.txt" u 1:($2*-1) '%lf,%lf' title "benchmark" w l ls 2 dashtype 4

set output 'ux_8_140_9n.png'
plot "../output/dynamic.dat" every ::399::499 u 1:3 title "code" w l ls 1, "../input/xDisp.txt" u 1:2 '%lf,%lf' title "benchmark" w l ls 2 dashtype 4
